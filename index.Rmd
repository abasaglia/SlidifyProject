...
#       c('multiBarChart', 'multiBarHorizontalChart',"line", "lineChart", "scatter","lineWithFocusChart","multiChart")
#     )
  ),
  mainPanel(
...
n1 <- nPlot(x ~ Group.1, group = 'Group.2',type = 'lineChart',
    data = x2
)
...
n2 <- nPlot(wmean ~ Year, group = 'Sex', type = 'lineChart',
    data = x3
)
